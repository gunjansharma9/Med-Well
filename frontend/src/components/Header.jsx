...
const Header = () => {
  return (
    <div className="w-full py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-br from-blue-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(8)].map((_, index) => (
          <motion.div
            key={index}
            className="absolute w-6 h-6 bg-blue-100 rounded-full opacity-30"
            style={{
              top: `${Math.random() * 100}%`,
              left: `${Math.random() * 100}%`
            }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <motion.div className="overflow-hidden">
            <motion.h1
              className="text-slate-800 text-4xl md:text-5xl lg:text-6xl font-bold mb-4"
            ...
            >
              ...
              <motion.span
                className="bg-gradient-to-r from-blue-600 to-teal-500 text-transparent bg-clip-text"
                initial={{ scale: 0.5, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
          ...
          >
            <motion.a
              href="#speciality"
              className="inline-flex items-center px-8 py-4 font-semibold text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-600 to-teal-500 hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <span className="relative z-10">Book Appointment Now</span>
        ...
        >
          <div className="relative group">
            ...
            <motion.div
              className="absolute -top-4 -right-4 px-4 py-2 bg-white rounded-full shadow-md border border-blue-100"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
