...
//             <div className='bg-white border-gray-300 px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
...
//                         <div className='flex-1 flex flex-col gap-1'>
//                             <p>Experience</p>
//                             <select onChange={(e) => setExperience(e.target.value)} value={experience} name="" id="experienceSelect">
...
//                         <div className='flex-1 flex flex-col gap-1'>
//                             <p>Date Of Birth</p>
//                             <input onChange={(e) => setDob(e.target.value)} value={dob} type="text" className='border border-gray-300 rounded px-3 py-2' placeholder='dob'/>
//                         </div>
...
//                         <div className='flex-1 flex flex-col gap-1'>
//                             <p>Speciality</p>
//                             <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border border-gray-300 rounded px-3 py-2' name="" id="specializationSelect">
...
//                     <textarea onChange={(e) => setAbout(e.target.value)} value={about} className=' border-gray-300 w-full px-4 pt-2 border rounded' placeholder='write about doctor' rows={5} required/>
//                 </div>
            ...
            <div className='bg-white border-gray-300 px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Experience</p>
                            <select className='border border-gray-300 rounded px-3 py-2' onChange={(e) => setExperience(e.target.value)} value={experience} name="" id="experienceSelect">
                                <option value="1 Year">1 Year</option>
                                <option value="2 Year">2 Year</option>
                                <option value="3 Year">3 Year</option>
                                <option value="4 Year">4 Year</option>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Date Of Birth</p>
                            <input onChange={(e) => setDob(e.target.value)} value={dob} type="date" className='border border-gray-300 rounded px-3 py-2' placeholder='Date of Birth' required />
                        </div>
                    </div>
